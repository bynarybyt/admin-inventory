...
import Logo from "../../images/common/coin-wallet.png";
...
const Login = () => {
  ...
  const handleLogin = (e) => {
    e.preventDefault();
    if (formData.email === "admin@bynarybyt.com" && formData.password === "admin123") {
      dispatch(login({mail: formData.email, isRemember: isRemember}));
    } else {
      setLoginError(true);
      setTimeout(() => {
        setLoginError(false);
